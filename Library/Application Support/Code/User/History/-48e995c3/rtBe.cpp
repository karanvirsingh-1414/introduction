...
class Student {
    ...
    Student() {                                                     // CONSTRUCTOR-1
        cout<<"I am a NON-PARAMETERISED CONSTRUCTOR...";
    }
...
int main() {
    Student s1;                          // As no parameter is given, therefore it will execute CONSTRUCTOR-1
    Student s1("Karanvir Singh");       // As  parameter is given, therefore it will execute CONSTRUCTOR-2
